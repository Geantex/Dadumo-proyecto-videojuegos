...
public class Encounter1 : MonoBehaviour
{
    ...
    public void functionButton1()
    {
        ...
        if (Random.Range(0, 4) == 0)
        {
            ...
            EncounterManager.ShowResults("Mientras saqueáis, una pila de tesoros particularmente ruidosos colapsa, ¡y el dragón instintivamente lanza una llamarada!" +
        ...
        else
        {
            ...
            EncounterManager.ShowResults("El dragón duerme profundamente, y ahora es 50 monedas de oro más pobre que antes. El dragón empieza a despertarse un poco," +
    ...
    public void functionButton2()
    {
        ...
        if (Random.Range(0, 2) == 0)
        {
            ...
            GameController.Instancia.modifyPartyHealthPoints(-40f);
            // DamageAllPercentage(0.4); (esta funcion no existe, se supone que daña a todo el grupo por un 40% de su salud)
            EncounterManager.ShowResults("El tesoro parece que tenía un encantamiento de alarma, ¡porque empieza a hacer un poderoso pitido que despierta al dragón, quien lanza una llamarada!" +
        ...
        else
        {
            ...
            GameController.Instancia.modifyGoldCoins(50f);
            EncounterManager.ShowResults("El dragón duerme profundamente, y os apropiáis un equipamiento con marcas de quemadura; su penúltimo propietario seguramente no lo echará de menos. El dragón empieza a despertarse un poco," +
    ...
    public void functionButton3()
    {
        ...
        EncounterManager.ShowResults("La discreción es el mejor amigo de los aventureros, el cementario está lleno de ladrones de dragones.");
    }
